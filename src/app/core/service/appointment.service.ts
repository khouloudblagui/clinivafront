...
export class AppointmentService {
  ...
  createAppointment(appointmentDTO: Partial<Appointment>): Observable<Appointment> {
    return this.http.post<Appointment>(`${this.apiUrl}/`, appointmentDTO);
  }

  // Update an existing appointment
  updateAppointment(appointmentId: number, updatedAppointment: Partial<Appointment>): Observable<Appointment> {
    return this.http.put<Appointment>(`${this.apiUrl}/${appointmentId}`, updatedAppointment);
  }
